...
estimator developed by Chen, Sant’Anna, and Xie (2025) in [their
paper](https://arxiv.org/abs/2506.17729) “Efficient
...
a much more robust implementation at some point. However, as of writing
(early August 2025), there does not appear to be a publicly available
implementation, so I hope this is better than nothing!

I must also caution that the code has not been vetted, so please take
care when using it. I do believe it is producing correct results, but I
cannot give a 100% guarantee just yet. I would highly recommend double
checking the code to ensure there are no issues (and if you find some
please let me know!).
